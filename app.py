...
@app.route('/')
def home():
    # c1 = Customers(customer_name = 'Muskan Gupta',email = 'muskan@gmail.com')
    # c2 = Customers(customer_name = 'Rashid Aziz',email = 'rashid@gmail.com')
    # c3 = Customers(customer_name = 'Bharati Panighari',email = 'bharati@gmail.com')
    # c4 = Customers(customer_name = 'Saima Shaikh',email = 'saimarshk@gmail.com')
    # c5 = Customers(customer_name = 'Dheeraj Lalwani',email = 'dheeraj@gmail.com')
    # c6 = Customers(customer_name = 'Vinayak Gupta',email = 'vinayak@gmail.com')
    # c7 = Customers(customer_name = 'Hrishita Kumar',email = 'hrishita@gmail.com')
    # c8 = Customers(customer_name = 'Zubiya Alvi',email = 'zubi@gmail.com')
    # c9 = Customers(customer_name = 'Aayush Muniya',email = 'aayush@gmail.com')
    # c10 = Customers(customer_name = 'Kamlesh Gupta',email = 'kamlesh@gmail.com')
